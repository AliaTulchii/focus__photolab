...
// interface HoursSlot {
//   selectedHours: number; // у хвилинах
...
//   // Перетворення selectedHours з хвилин в години
//   const formattedSelectedHours = selectedHours === 80
//   ? (selectedHours / 60).toFixed(2) // Це рядок
//   : (selectedHours / 60).toString(); // Це також рядок

// const numericSelectedHours = parseFloat(formattedSelectedHours);
//   // const formattedSelectedHours = selectedHours / 60;
...
//     const startHour = 8;
//     const endHour = 21;
//     const interval = hours  + breakMinutes;
...
//         const endHourFormatted = `${i + hours < 10 ? "0" : ""}${i + hours}:` + breakMinutes; // Ураховуємо хвилини
//         availableHours.push({
...
//     console.log("Generated available hours for", format(day, "yyyy-MM-dd"), ":", availableHours);
...
//         numericSelectedHours, // перетворення хвилин в години
//         day
//       );
...
//           selectedHours={numericSelectedHours}
//         />
//       </DownModal>
